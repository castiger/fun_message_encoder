...
var complexity = document.getElementById('complexity').value + 1;
...
const encmatrixcontainer = {
  ...
  "Military" : [['Juliett ','Kilo ','Victor ','Whiskey ','Zulu ','Echo ','Foxtrot ','Bravo ','One ','Two ','Three ','Four ','Five ','Six ','Seven ','Eight ','Nine ','Zero ','Ten ','Sierra ','Tango ','Charlie ', 'Alpha ', 'Beta ', 'Gamma ', 'Delta ', 'Epsilon ', 'Digamma ', 'Zeta ', 'Eta ', 'Theta ', 'Iota ', 'Omicron ','Kappa ','Omega ']],
...
document.getElementById('phrasedisplay').innerHTML = 'Complexity too low for this message, set it higher.';
...
document.getElementById('phrasedisplay').innerHTML = "Complexity is too low for this message, set it higher."
 failed = 1;
  break loop1;
  break loop2;
  break;
