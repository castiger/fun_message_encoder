...
const encmatrixcontainerdata = {
  ...
  "Character": {
    ...
    BaseCharacterDiversity: 3,
    BaseComplexity: 0,
    BaseDeepCharacterDiversity: 0,
    DeepCharacterMode: "None",
    RandomCharSize: 0
  },
  "Deep Character": {
    HasCharacters: 0,
...
function SeedEncrypt(decrypting) {
  ...
  var customencode = document.getElementById('customencode').value;

  if (customencode.length == 0) {
    ...
    case 'Super':
      ...
      var deepcharmode = encmatrixcontainerdata[theme]["DeepCharacterMode"];
      var hascharacters = encmatrixcontainerdata[theme]["HasCharacters"];
      var userandomcharactersize = encmatrixcontainerdata[theme]["RandomCharSize"];
      var charactermutationdiversity = encmatrixcontainerdata[theme]["BaseCharacterDiversity"];
    ...
    var theme = "custom";
    var complexity = parseInt(document.getElementById('complexity').value) + 2;
    var encryptionmatrix = [customencode.split(',')];
    var hascharacters = 0;
    var userandomcharactersize = 1;
    var deepcharmode = "All";
    var charactermutationdiversity = 5;
    var theme
  ...
  var n = 0
    for (; n < charactermutationdiversity + complexity; n++) {
      var m = 0;
        ...
        if (contains == 0) {
          ...
          if (failedattempts >= 300) {
            if (theme !== "custom") {
              ...
              document.getElementById('phrasedisplay').innerHTML = 'Your custom encode is not complex enough, add more entries.'
