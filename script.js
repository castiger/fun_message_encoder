 const encmatrixcontainer = {
    ...
    "Deep Character" : [['̀','́','̂','̃','̄','̅','̆','̇','̈','̉','̊','̋','̌','̍','̎','̏','̐','̑','̒','o','̕','̖','̗','̘','̙','̚','̛','̜','̝','̞','̟','̠','̣','̤','̥','̦','̧','̨','̩','̪','̫','̬','̭','̮','̯','̰','̱','̲','̳','̴','̵','̶','̷','̸','̹','̺','̻','̼','̽','̾','̿','̀','́','͂','̓','́','ͅ','͆','͇','͈','͉','͊','͋','͌','͍','͎','͏','͐','͑','͒','͓','͔','͕','͖','͗','͘','͙','͚','͛','͜','͝','͞','͟','͠','͡','͢','ͣ','ͤ','ͥ','ͦ','ͧ','ͨ','ͩ','ͪ','ͫ','ͬ','ͭ','ͮ',]],
  ...
  const encmatrixcontainerdata = {
    "Veggie": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Fruit": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Tree": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Character": {HasCharacters:0, BaseCharacterDiversity:2, BaseComplexity:0, BaseDeepCharacterDiversity:0, UseInvisible:2, RandomCharSize:0},
    "Deep Character": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:1, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Invisible Character": {HasCharacters:0, BaseCharacterDiversity:5, BaseComplexity:3, BaseDeepCharacterDiversity:3, UseInvisible:1, RandomCharSize:0},
    "Military": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Animal": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Location": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Object": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Spice": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Profession": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "TV Movie": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Rock": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Elements": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Action": {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:0},
    "Robot" : {HasCharacters:0, BaseCharacterDiversity:3, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:2, RandomCharSize:0},
    "Super" :  {HasCharacters:1, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:2, UseInvisible:1, RandomCharSize:1},
    "Uncertain" : {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
    "Amazed" : {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
    "Hmm" :{HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
    "Duck" : {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
    "Donkey" : {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
    "?????" : {HasCharacters:0, BaseCharacterDiversity:0, BaseComplexity:0, BaseDeepCharacterDiversity:1, UseInvisible:1, RandomCharSize:1},
...
function SeedEncrypt(decrypting) {
  ...
  var invisallowed = encmatrixcontainerdata[theme]["UseInvisible"];
  ...
  if (theme !== 0) {
    ...
    case 'Super':
      ...
      var hascharacters = encmatrixcontainerdata[theme]["HasCharacters"];
      break;
  ...
  var n = 0
  for (;n < encmatrixcontainerdata[theme]["BaseCharacterDiversity"] + complexity; n++){
  var m = 0;
  ...
  for (; m < characterstomutatelength; ) {
    ...
    switch (theme) {
      case "Action":
      var actionbegin = actionbeginarray[Math.floor(random_number()*actionbeginarray.length)];
      var punctroll1 = Math.floor(random_number()*2);
      if (punctroll1 == 0){
        var punctroll2 = 1;
        var chosenpunctuation = ',';
      } else {
        var chosenpunctuation = '.';
      var punctroll2 = Math.floor(random_number()*4 + 2);

      }

      CurrentEncString = actionbegin + CurrentEncString + encryptionmatrix[wordarrayindex][Math.floor(random_number() * encryptionmatrix[wordarrayindex].length)] + 'and';
        
      
      var p = 0;
      for (;p < punctroll2; p++){
      CurrentEncString = CurrentEncString + chosenpunctuation;
      }
      CurrentEncString = CurrentEncString + ' ';
        break;
    
      default:
      var stringtoadd = encryptionmatrix[wordarrayindex][Math.floor(random_number() * encryptionmatrix[wordarrayindex].length)];
      if (encmatrixcontainerdata[theme]["RandomCharSize"] == 1) {

      var s = 0;
      for (;s < stringtoadd.length; s++){
        if (isLetter(stringtoadd[s])){
        var stringsizeroll = Math.floor(random_number()* 3);
        if (stringsizeroll == 0){
          var capitalcharacter = stringtoadd[s].toUpperCase();
          stringtoadd = setCharAt(stringtoadd, s, capitalcharacter)
      ...
      CurrentEncString = CurrentEncString + stringtoadd;
        break;
    }


      z = 0;
if (theme !== "Invisible Character" && theme !== "Deep Character"){
  
      for (; z < (deepcomplexity * 4); z++) {
        if (Math.floor(random_number() * 2) == 1) {
          var sideroll = Math.floor(random_number() * 2);
          var sideroll2 = Math.floor(random_number() * 2);
          if (invisallowed == 2){
          var chosencharactertype = "Invisible Character";

          } else if(invisallowed == 0 || sideroll2 == 0){
          ...
          CurrentEncString = encmatrixcontainer[chosencharactertype][0][Math.floor(random_number() * encmatrixcontainer[chosencharactertype][0].length)] + CurrentEncString;
    ...
    for (;a1 < mutatedcharactersmatrix.length; a1++){
      a2 = 0;
    for (; a2 < mutatedcharactersmatrix[a1].length; a2++) {
      if (mutatedcharactersmatrix[a1][a2].startsWith(CurrentEncString) || mutatedcharactersmatrix[a1][a2] == CurrentEncString) {
        contains = 1;
        break;
      }
    }
    ...
    for (; a < mutatedcharacters.length; a++) {
      if (mutatedcharacters[a].startsWith(CurrentEncString) || mutatedcharacters[a] == CurrentEncString) {
        contains = 1;
        break;
      }
    }
    ...
    if (contains == 0) {
      ...
      if (failedattempts >= 300) {
        document.getElementById('phrasedisplay').innerHTML = 'Key is invalid or message is incomplete. Error ID : 1'
          failed = 1;
        break;
      }
    };
  ...
  if (failed == 0){
    mutatedcharactersmatrix.push(mutatedcharacters);
    mutatedcharacters = [];
  ...
  if (decrypting !== 0) {
    ...
    for (; d < stringlength; ) {
     ...
     for (;y < mutatedcharactersmatrix.length; y++){
      ...
      for (; t < mutatedcharactersmatrix[y].length; t++) {
        if (string.startsWith(mutatedcharactersmatrix[y][t])) {
          failedattempts = 0;
          t = mutatedcharactersmatrix[y].length;
          d = stringlength;
        } else if (t == mutatedcharactersmatrix[y].length) {
          d = stringlength;
          document.getElementById('phrasedisplay').innerHTML = 'Key is invalid or message is incomplete. Error ID : 2';
  ...
  if (typeof invalidkey == 'undefined') {
    if (decrypting == 0) {
      ...
      for (; e < stringlength; e++) {
        ...
        var charactertoreplacesubindex = Math.floor(Math.random()*mutatedcharactersmatrix.length);
      ...
      for (; d < stringlength; ) {
        ...
        for (; t < mutatedcharactersmatrix[y].length; t++) {
          if (string.startsWith(mutatedcharactersmatrix[y][t])) {
            ...
            failedattempts++
            if (failedattempts >= 100000) {
              document.getElementById('phrasedisplay').innerHTML = 'Key is invalid or message is incomplete. Error ID : 4'
                failed = 1;
              break loop1;
              break loop2;
              break;
        ...
        if (d == 0) {
          ...
          if (failedattempts >= 500) {
            document.getElementById('phrasedisplay').innerHTML = 'Key is invalid or message is incomplete. Error ID : 5'
              failed = 1;
            break loop1;
            break;
          };
